...
- (void)didMoveToWindow { // add media player
    ...
    else if ([fontFamilyValue intValue] == 1) [[self diarySongTitleLabel] setFont:[UIFont systemFontOfSize:22 weight:UIFontWeightRegular]];
    ...
    else if ([fontFamilyValue intValue] == 1) [[self diaryArtistLabel] setFont:[UIFont systemFontOfSize:16 weight:UIFontWeightRegular]];
